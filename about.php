...
<div id='reportdiv'>	   
	<div class="panel panel-default">
		<div class="panel-body" style="margin-left:50px; width:65%px;">    
			...
			<div>
				Welcome to the community-driven OpenGL hardware database, an online tool for developers that want to check out the OpenGL hardware capabilities for the different<br>
